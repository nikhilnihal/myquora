...
$db= mysql_select_db("nikhil_db",$conn);
  ...
  while($row=mysql_fetch_assoc($result))
  {
         ...
         $qq=$row['ans_id'];
     echo "<a href='a_upvote.php?ja=$qq&qid=$n1'>";  echo "upvote";    echo "</a>";   echo $row['a_upvote'];     echo"  ";
     echo "<a href='a_downvote.php?ja=$qq&qid=$n1'>"; echo "downvote";  echo "</a>";  echo $row['a_downvote'];    echo"    "; echo "<br>";
